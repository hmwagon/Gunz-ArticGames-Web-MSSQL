<?
ModulsTitle("AeroGamez Gunz - Articulos Donator");
...
$res = mssql_query("SELECT * FROM ItemPremium(nolock) $conditions $sortq");
...
while( $a = mssql_fetch_object($res) ){
    ...
    $set[$count][$page]['Type']         =   GetTypeByID($a->Type);
...
if($cpage > $page)
{
    Messenger_Gunz("Error de la tienda, número de página incorrecto.","?mod=itempremium");
    die();
    ...
    Messenger_Gunz("No puede retroceder mas.","?mod=itempremium");
    die();
}
...
for ($i = 1; $i <= $page; $i++) {
    ...
    $pageactive.="<a $pageactiv href='?mod=itempremium&page=$i&sex=$sex&sort=$sort&bodypart=$bodypart'>$i</a>";
 ...
 if ($cpage >=2) {
     $previous.="<a href='?mod=itempremium&page=$b&sex=$sex&sort=$sort&bodypart=$bodypart'>".RANKING_13."</a>";
 }
if ($cpage < $page) {
    $next.="<a href='?mod=itempremium&page=$a&sex=$sex&sort=$sort&bodypart=$bodypart'>".RANKING_14."</a>";
}
...
<div class="module">
    <div>
        ...
        <form method="GET" name="setlist" action="index.php?mod=itempremium">
            <p align="center">
                <select name="bodypart" onChange="document.location = 'index.php?mod=itempremium&sex=' + document.setlist.sex.value + '&sort=' + document.setlist.sort.value + '&bodypart=' + document.setlist.bodypart.value;">
                ...
                <select <?=($_GET[bodypart] == 0 || $_GET[bodypart] == 6) ? "disabled " : ""?>size="1" name="sex" onChange="document.location = 'index.php?mod=itempremium&sex=' + document.setlist.sex.value + '&sort=' + document.setlist.sort.value + '&bodypart=' + document.setlist.bodypart.value;">
                <?
                ...
                <select name="sort" onChange="document.location = 'index.php?mod=itempremium&sex=' + document.setlist.sex.value + '&sort=' + document.setlist.sort.value + '&bodypart=' + document.setlist.bodypart.value;">
                ...
                <ul class="itemlisting">
                    ...
                    <li>
                        <span>
                            ...
                            <p><strong><?=$set[1][$cpage]['Price']?></strong> DC</p>
                        </span>
                        <p class="itemname"><?=$set[1][$cpage]['Name']?></p>
                        <p>Tipo: <?=$set[1][$cpage]['Type']?></p>
                        <p>Sexo: <?=$set[1][$cpage]['Sex']?></p>
                        <p>Nivel: <?=$set[1][$cpage]['Level']?></p>
                        <p class="buyoptions"><a href="?mod=infopremium&itemid=<?=$set[1][$cpage]['CSSID']?>&cat=<?=$set[1][$cpage]['Type']?>" class="btn st3">Información del Articulo</a></p>
                    </li>
                    <?
                        }
                        if($set[2][$cpage]['Name'] <> ""){
                    ...
                    <li>
                        <span>
                            ...
                            <p><strong><?=$set[2][$cpage]['Price']?></strong> DC</p>
                        </span>
                        <p class="itemname"><?=$set[2][$cpage]['Name']?></p>
                        <p>Tipo: <?=$set[2][$cpage]['Type']?></p>
                        <p>Sexo: <?=$set[2][$cpage]['Sex']?></p>
                        <p>Nivel: <?=$set[2][$cpage]['Level']?></p>
                        <p class="buyoptions"><a href="?mod=infopremium&itemid=<?=$set[2][$cpage]['CSSID']?>&cat=<?=$set[2][$cpage]['Type']?>" class="btn st3">Información del Articulo</a></p>
                    </li>
                    <?
                        }
                        if($set[3][$cpage]['Name'] <> ""){
                    ...
                    <li>
                        <span>
                            ...
                            <p><strong><?=$set[3][$cpage]['Price']?></strong> DC</p>
                        </span>
                        <p class="itemname"><?=$set[3][$cpage]['Name']?></p>
                        <p>Tipo: <?=$set[3][$cpage]['Type']?></p>
                        <p>Sexo: <?=$set[3][$cpage]['Sex']?></p>
                        <p>Nivel: <?=$set[3][$cpage]['Level']?></p>
                        <p class="buyoptions"><a href="?mod=infopremium&itemid=<?=$set[3][$cpage]['CSSID']?>&cat=<?=$set[3][$cpage]['Type']?>" class="btn st3">Información del Articulo</a></p>
                    </li>
                    <?
                        }
                        if($set[4][$cpage]['Name'] <> ""){
                    ...
                    <li>
                        <span>
                            ...
                            <p><strong><?=$set[4][$cpage]['Price']?></strong> DC</p>
                        </span>
                        <p class="itemname"><?=$set[4][$cpage]['Name']?></p>
                        <p>Tipo: <?=$set[4][$cpage]['Type']?></p>
                        <p>Sexo: <?=$set[4][$cpage]['Sex']?></p>
                        <p>Nivel: <?=$set[4][$cpage]['Level']?></p>
                        <p class="buyoptions"><a href="?mod=infopremium&itemid=<?=$set[4][$cpage]['CSSID']?>&cat=<?=$set[4][$cpage]['Type']?>" class="btn st3">Información del Articulo</a></p>
                    </li>
                    <?
                        }
                        if($set[5][$cpage]['Name'] <> ""){
                    ...
                    <li>
                        <span>
                            ...
                            <p><strong><?=$set[5][$cpage]['Price']?></strong> DC</p>
                        </span>
                        <p class="itemname"><?=$set[5][$cpage]['Name']?></p>
                        <p>Tipo: <?=$set[5][$cpage]['Type']?></p>
                        <p>Sexo: <?=$set[5][$cpage]['Sex']?></p>
                        <p>Nivel: <?=$set[5][$cpage]['Level']?></p>
                        <p class="buyoptions"><a href="?mod=infopremium&itemid=<?=$set[5][$cpage]['CSSID']?>&cat=<?=$set[5][$cpage]['Type']?>" class="btn st3">Información del Articulo</a></p>
                    </li>
                    <?
                        }
                        if($set[6][$cpage]['Name'] <> ""){
                    ...
                    <li>
                        <span>
                            ...
                            <p><strong><?=$set[6][$cpage]['Price']?></strong> DC</p>
                        </span>
                        <p class="itemname"><?=$set[6][$cpage]['Name']?></p>
                        <p>Tipo: <?=$set[6][$cpage]['Type']?></p>
                        <p>Sexo: <?=$set[6][$cpage]['Sex']?></p>
                        <p>Nivel: <?=$set[6][$cpage]['Level']?></p>
                        <p class="buyoptions"><a href="?mod=infopremium&itemid=<?=$set[6][$cpage]['CSSID']?>&cat=<?=$set[6][$cpage]['Type']?>" class="btn st3">Información del Articulo</a></p>
                    </li>
                    <?
                        }
                        if($set[7][$cpage]['Name'] <> ""){
                    ...
                    <li>
                        <span>
                            ...
                            <p><strong><?=$set[7][$cpage]['Price']?></strong> DC</p>
                        </span>
                        <p class="itemname"><?=$set[7][$cpage]['Name']?></p>
                        <p>Tipo: <?=$set[7][$cpage]['Type']?></p>
                        <p>Sexo: <?=$set[7][$cpage]['Sex']?></p>
                        <p>Nivel: <?=$set[7][$cpage]['Level']?></p>
                        <p class="buyoptions"><a href="?mod=infopremium&itemid=<?=$set[7][$cpage]['CSSID']?>&cat=<?=$set[7][$cpage]['Type']?>" class="btn st3">Información del Articulo</a></p>
                    </li>
                    <?
                        }
                        if($set[8][$cpage]['Name'] <> ""){
                    ...
                    <li>
                        <span>
                            ...
                            <p><strong><?=$set[8][$cpage]['Price']?></strong> DC</p>
                        </span>
                        <p class="itemname"><?=$set[8][$cpage]['Name']?></p>
                        <p>Tipo: <?=$set[8][$cpage]['Type']?></p>
                        <p>Sexo: <?=$set[8][$cpage]['Sex']?></p>
                        <p>Nivel: <?=$set[8][$cpage]['Level']?></p>
                        <p class="buyoptions"><a href="?mod=infopremium&itemid=<?=$set[8][$cpage]['CSSID']?>&cat=<?=$set[8][$cpage]['Type']?>" class="btn st3">Información del Articulo</a></p>
                    </li>
                    <?
                        }
                        if($set[9][$cpage]['Name'] <> ""){
                    ...
                    <li>
                        <span>
                            ...
                            <p><strong><?=$set[9][$cpage]['Price']?></strong> DC</p>
                        </span>
                        <p class="itemname"><?=$set[9][$cpage]['Name']?></p>
                        <p>Tipo: <?=$set[9][$cpage]['Type']?></p>
                        <p>Sexo: <?=$set[9][$cpage]['Sex']?></p>
                        <p>Nivel: <?=$set[9][$cpage]['Level']?></p>
                        <p class="buyoptions"><a href="?mod=infopremium&itemid=<?=$set[9][$cpage]['CSSID']?>&cat=<?=$set[9][$cpage]['Type']?>" class="btn st3">Información del Articulo</a></p>
                    </li>
                    <?
                        }
                    ...
                    <li>
                        <span>
                            ...
                            <p><strong><?=$set[10][$cpage]['Price']?></strong> DC</p>
                        </span>
                        <p class="itemname"><?=$set[10][$cpage]['Name']?></p>
                        <p>Tipo: <?=$set[10][$cpage]['Type']?></p>
                        <p>Sexo: <?=$set[10][$cpage]['Sex']?></p>
                        <p>Nivel: <?=$set[10][$cpage]['Level']?></p>
                        <p class="buyoptions"><a href="?mod=infopremium&itemid=<?=$set[10][$cpage]['CSSID']?>&cat=<?=$set[10][$cpage]['Type']?>" class="btn st3">Información del Articulo</a></p>
                    </li>
                    <?
                        }
                    ...
                    <li>
                        <span>
                            ...
                            <p><strong><?=$set[11][$cpage]['Price']?></strong> DC</p>
                        </span>
                        <p class="itemname"><?=$set[11][$cpage]['Name']?></p>
                        <p>Tipo: <?=$set[11][$cpage]['Type']?></p>
                        <p>Sexo: <?=$set[11][$cpage]['Sex']?></p>
                        <p>Nivel: <?=$set[11][$cpage]['Level']?></p>
                        <p class="buyoptions"><a href="?mod=infopremium&itemid=<?=$set[11][$cpage]['CSSID']?>&cat=<?=$set[11][$cpage]['Type']?>" class="btn st3">Información del Articulo</a></p>
                    </li>
                    <?
                        }
                    ...
                    <li>
                        <span>
                            ...
                            <p><strong><?=$set[12][$cpage]['Price']?></strong> DC</p>
                        </span>
                        <p class="itemname"><?=$set[12][$cpage]['Name']?></p>
                        <p>Tipo: <?=$set[12][$cpage]['Type']?></p>
                        <p>Sexo: <?=$set[12][$cpage]['Sex']?></p>
                        <p>Nivel: <?=$set[12][$cpage]['Level']?></p>
                        <p class="buyoptions"><a href="?mod=infopremium&itemid=<?=$set[12][$cpage]['CSSID']?>&cat=<?=$set[12][$cpage]['Type']?>" class="btn st3">Información del Articulo</a></p>
                    </li>
                    <?
                        }
                    ...
                    <li>
                        <span>
                            ...
                            <p><strong><?=$set[13][$cpage]['Price']?></strong> DC</p>
                        </span>
                        <p class="itemname"><?=$set[13][$cpage]['Name']?></p>
                        <p>Tipo: <?=$set[13][$cpage]['Type']?></p>
                        <p>Sexo: <?=$set[13][$cpage]['Sex']?></p>
                        <p>Nivel: <?=$set[13][$cpage]['Level']?></p>
                        <p class="buyoptions"><a href="?mod=infopremium&itemid=<?=$set[13][$cpage]['CSSID']?>&cat=<?=$set[13][$cpage]['Type']?>" class="btn st3">Información del Articulo</a></p>
                    </li>
                    <?
                        }
                    ...
                    <li>
                        <span>
                            ...
                            <p><strong><?=$set[14][$cpage]['Price']?></strong> DC</p>
                        </span>
                        <p class="itemname"><?=$set[14][$cpage]['Name']?></p>
                        <p>Tipo: <?=$set[14][$cpage]['Type']?></p>
                        <p>Sexo: <?=$set[14][$cpage]['Sex']?></p>
                        <p>Nivel: <?=$set[14][$cpage]['Level']?></p>
                        <p class="buyoptions"><a href="?mod=infopremium&itemid=<?=$set[14][$cpage]['CSSID']?>&cat=<?=$set[14][$cpage]['Type']?>" class="btn st3">Información del Articulo</a></p>
                    </li>
                    <?
                        }
                    ...
                    <li>
                        <span>
                            ...
                            <p><strong><?=$set[15][$cpage]['Price']?></strong> DC</p>
                        </span>
                        <p class="itemname"><?=$set[15][$cpage]['Name']?></p>
                        <p>Tipo: <?=$set[15][$cpage]['Type']?></p>
                        <p>Sexo: <?=$set[15][$cpage]['Sex']?></p>
                        <p>Nivel: <?=$set[15][$cpage]['Level']?></p>
                        <p class="buyoptions"><a href="?mod=infopremium&itemid=<?=$set[15][$cpage]['CSSID']?>&cat=<?=$set[15][$cpage]['Type']?>" class="btn st3">Información del Articulo</a></p>
                    </li>
                    <?
                        }
                    ...
                    <li>
                        <span>
                            ...
                            <p><strong><?=$set[16][$cpage]['Price']?></strong> DC</p>
                        </span>
                        <p class="itemname"><?=$set[16][$cpage]['Name']?></p>
                        <p>Tipo: <?=$set[16][$cpage]['Type']?></p>
                        <p>Sexo: <?=$set[16][$cpage]['Sex']?></p>
                        <p>Nivel: <?=$set[16][$cpage]['Level']?></p>
                        <p class="buyoptions"><a href="?mod=infopremium&itemid=<?=$set[16][$cpage]['CSSID']?>&cat=<?=$set[16][$cpage]['Type']?>" class="btn st3">Información del Articulo</a></p>
                    </li>
                    <?
                        }
                    ?>
